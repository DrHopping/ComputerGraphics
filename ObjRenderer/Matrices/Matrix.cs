...
namespace ObjRenderer.Matrices
{
    public class Matrix
    {
        ...
        public float this[int row, int column] => values[row, column];
        ...
        public Matrix Multiply(Matrix matrix)
        {
            ...
            var size = Columns;
            var result = new float[Rows, matrix.Columns];
        ...
        public Matrix Inverse()
        {
            ...
            var inverseValues = new float[Columns, Rows];
        ...
        internal IEnumerable<float> Row(int row)
        {
        ...
        internal IEnumerable<float> Column(int column)
        {
